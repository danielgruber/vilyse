...
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-classic-1.0.0.jar"
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-core-1.0.0.jar"
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-examples/logback-examples-1.0.0.jar"
